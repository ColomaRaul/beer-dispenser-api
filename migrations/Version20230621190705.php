...
final class Version20230621190705 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dispenser_event (id UUID PRIMARY KEY, dispenser_id UUID not null, updated_at TIMESTAMP WITH TIME ZONE, opened_at TIMESTAMP WITH TIME ZONE, closed_at TIMESTAMP WITH TIME ZONE, total_spent float default 0.0)');
    }
